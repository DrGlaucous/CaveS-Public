...
pub struct BossNPC {
    ...
    pub parts: [NPC; 20], //list of sub-NPCs that make up the boss (just like CSE2)
    pub hurt_sound: [u8; 20], //noizes
    ...
    fn tick(
        ...
        for part in &mut self.parts {
            if part.shock > 0 {
                ...
                // I don't know where the best place to put this is, but let's try putting it here (not my comment)
