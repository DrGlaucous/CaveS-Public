...
pub struct NPCConsts {
    ...
    //not sure what these preprocessor commands are for...
    //looks like some sort of modding support?
    //if it is defined as default, the program will use the default_nXXX_NPC rects defined below.
    //otherwise, it seems to just init an empty rect of that size...
    ...
    //still not sure what these do, but I will add them in anyway

    //this is used for 371,372,373,374,375
...
//weird that these are set up with a function... i guess with modding and lua, you could just replace this init fucntion with whatever you wanted
//to reskin the NPC how you like

//this is used for 371,372,373,374,375
fn default_n371_adam() -> SafeNPCRect<6>{
