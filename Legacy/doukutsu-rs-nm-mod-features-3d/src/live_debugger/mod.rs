    ...
    pub fn run_ingame(
            ...
            ui.window("Command Line")
                ...
                .build(|| {
...

                    {
                        ...
                        ui.input_text("##cmd", &mut self.command_line_parser.buffer).build();
                    }
        ...
        ui.window("Debugger")
            ...
            .build(|| {
                ...
                ui.slider("##GameSpeedSlider", 0.1, 3.0, &mut speed);
                ui.same_line();
                if ui.button("Reset") {
                    speed = 1.0
                }
        ...
        if self.events_visible {
            ui.window("TSC Scripts")
                ...
                .build(|| {
                    ...
                    ui.push_item_width(-1.0);
                    ui.list_box("##EventListBox", &mut self.selected_event, &events, 10);
