...
use crate::framework::backend::{BackendShader, SpriteBatchCommand, VertexData, BackendTexture};
...
impl WaterRenderer {
    ...
    pub fn initialize(
        &mut self,
        regions: Vec<(WaterRegionType, Rect<u16>, u16)>,
    ...
    pub fn draw(
        ...
        frame: &Frame,
        layer: WaterLayer,
        dest_tex: Option<&Box<dyn BackendTexture>>,
    ) -> GameResult<()> {
