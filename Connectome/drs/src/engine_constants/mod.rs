...
impl EngineConstants {
    //apply default values to the engine constants, the other functions will modifiy them on demand as needed
    ...
    //"base" stands for vanilla CS
    pub fn is_base(&self) -> bool {
        !self.is_switch && !self.is_cs_plus && !self.is_demo
    }

    //switch constants (why is it called NX?)
    pub fn apply_csplus_nx_patches(&mut self) {
        ...
        self.textscript.animated_face_pics = true; //hmm... I could do something with this...
        ...
        self.player_skin_paths.push("mychar_p2".to_owned()); //mychar for player 2 goes into this file
    }
