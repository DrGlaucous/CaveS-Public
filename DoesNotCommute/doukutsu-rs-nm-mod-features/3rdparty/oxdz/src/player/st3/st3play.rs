...
// TABLES
lazy_static! {
    static ref XFINETUNE_AMIGA: Box<[i16; 16]> = Box::new([
        7895, 7941, 7985, 8046, 8107, 8169, 8232, 8280,
        8363, 8413, 8463, 8529, 8581, 8651, 8723, 8757
    ]);

    static ref RETRIGVOLADD: Box<[i8; 32]> = Box::new([
        0, -1, -2, -4, -8,-16,  0,  0,
        0,  1,  2,  4,  8, 16,  0,  0,
        0,  0,  0,  0,  0,  0, 10,  8,
        0,  0,  0,  0,  0,  0, 24, 32
    ...
    static ref NOTESPD: Box<[u16; 12]> = Box::new([
    ...
    static ref VIBSIN: Box<[i16; 64]> = Box::new([
    ...
    static ref VIBSQU: Box<[u8; 64]> = Box::new([
    ...
    static ref VIBRAMP: Box<[i16; 64]> = Box::new([
