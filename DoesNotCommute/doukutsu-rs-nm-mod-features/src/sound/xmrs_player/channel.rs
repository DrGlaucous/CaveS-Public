...
use xmrsplayer::effect::*;
use xmrsplayer::effect_arpeggio::EffectArpeggio;
use xmrsplayer::effect_multi_retrig_note::EffectMultiRetrigNote;
use xmrsplayer::effect_portamento::EffectPortamento;
use xmrsplayer::effect_toneportamento::EffectTonePortamento;
use xmrsplayer::effect_vibrato_tremolo::EffectVibratoTremolo;
use xmrsplayer::effect_volume_panning_slide::EffectVolumePanningSlide;
use xmrsplayer::historical_helper::HistoricalHelper;
use xmrsplayer::period_helper::PeriodHelper;
use xmrsplayer::triggerkeep::*;

use xmrsplayer::helper::*;
use xmrsplayer::state_instr_default::StateInstrDefault;
use xmrs::prelude::*;
...
impl<'a> Channel<'a> {
    pub fn new(module: Rc<Module>, rate: f32, historical: Option<HistoricalHelper>) -> Self {
