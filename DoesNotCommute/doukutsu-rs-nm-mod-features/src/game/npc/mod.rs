...
impl GameEntity<([&mut Player; 2], &NPCList, &mut Stage, &mut BulletManager, &mut Flash, &mut BossNPC, &mut Frame)> for NPC {
    fn tick(
        ...
        match self.npc_type {
            ...
            64 => self.tick_n064_first_cave_critter(state, players, npc_list),
            65 => self.tick_n065_first_cave_bat(state, players, npc_list),
            ...
            75 => self.tick_n075_kanpachi(state, players, npc_list),
            76 => self.tick_n076_flowers(),
            77 => self.tick_n077_yamashita(state),
            78 => self.tick_n078_pot(state),
            79 => self.tick_n079_mahin(state, players, npc_list),
            80 => self.tick_n080_gravekeeper(state, players, npc_list),
            81 => self.tick_n081_giant_pignon(state, players, npc_list),
            ...
            315 => self.tick_n315_ma_pignon_clone(state, players, npc_list, bullet_manager),
            ...
            372 => self.tick_n372_n373_fake_pc_sub(players, npc_list),
            373 => self.tick_n372_n373_fake_pc_sub(players, npc_list),
